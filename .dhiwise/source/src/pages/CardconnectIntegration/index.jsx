        ...
        <div className="flex flex-col items-start justify-start w-full">
            ...
            <div className="flex flex-col items-center justify-start mx-auto md:px-5 w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                ...
                <Input
                  ...
                  size="xs"
                ></Input>
                <div className="bg-white-A700 border border-blue_gray-100_01 border-solid flex flex-col font-opensans h-14 items-end justify-start md:ml-[0] ml-[480px] p-2 rounded-[50%] w-14">
          ...
          <div className="flex md:flex-col flex-row gap-8 items-start justify-start md:px-5 w-1/2 md:w-full">
            ...
            <div className="flex flex-1 flex-col gap-7 items-start justify-start md:mt-0 mt-[39px] w-full">
              ...
              <div className="bg-white-A700 flex flex-col items-center justify-start p-4 rounded-lg w-full">
                <div className="flex flex-col items-start justify-start w-full">
                  ...
                  <Button
                    className="cursor-pointer font-medium mt-4 text-center text-sm w-[342px]"
                    shape="round"
                    size="md"
                  >
                    Generate Key
