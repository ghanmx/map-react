          ...
          <div className="bg-white-A700 flex md:flex-1 flex-col items-center justify-start p-4 rounded-lg shadow-bs1 w-[68%] md:w-full">
            <div className="flex flex-col items-center justify-start mb-4 w-[97%] md:w-full">
              <Input
                ...
                variant="underline"
              ></Input>
              <div className="bg-white-A700 border border-blue_gray-100_01 border-solid flex flex-col items-start justify-start mt-7 p-4 rounded w-full">
                <div className="flex flex-col gap-[30px] justify-start my-2 w-[74%] md:w-full">
                  <div className="flex flex-row font-gilroy gap-4 items-start justify-start w-[41%] md:w-full">
                    <Img
                      className="h-9 w-9"
                    ...
                    />
                    <Img
                      className="h-[30px] mt-[3px] w-[21%]"
                      src="images/img_paymentmethod.svg"
                      alt="PaymentMethod"
                    />
                    <Text
                      className="mt-[9px] text-black-900_01 text-xl"
                  ...
                  <Button
                    className="cursor-pointer font-medium font-opensans md:ml-[0] ml-[52px] rounded text-base text-center w-[500px]"
                    size="2xl"
                  >
                    Pay $1120.58
                  </Button>
              ...
              >
                <div className="bg-white-A700 border border-blue_gray-100_01 border-solid flex flex-1 flex-row gap-6 items-center justify-start p-4 rounded w-full">
                  <Img
                  ...
                  />
                  <Img
                    className="h-[34px] md:h-auto object-cover w-[6%]"
                ...
                <div className="bg-white-A700 border border-blue_gray-100_01 border-solid flex flex-1 flex-row gap-6 items-center justify-start p-4 rounded w-full">
                  ...
                  />
                  <Img
                    className="h-4 md:h-auto object-cover w-[6%]"
